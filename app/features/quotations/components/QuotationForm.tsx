...
import { DynamicAttributeFields } from '~/features/orders/components/DynamicAttributeFields'
    ...
    <Form method='post'>
      ...
      <div className='space-y-6'>
        ...
        <section className='bg-card rounded-xl p-6 shadow-sm'>
          <h2 className='mb-4 font-semibold'>Quotation Information</h2>
        ...
        <div className='bg-card flex items-center justify-between rounded-xl p-6 shadow-sm'>
          ...
          <div className='flex items-center gap-3'>
            <Button type='button' variant='outline' asChild>
              <a href='/purchase/quotations'>Cancel</a>
            </Button>
            <Button
              type='submit'
