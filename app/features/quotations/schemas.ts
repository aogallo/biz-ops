...
export const insertQuotationDetailSchema =
  createInsertSchema(quotationDetailModel)
export const selectQuotationDetailSchema =
  createSelectSchema(quotationDetailModel)
export const insertQuotationRecipientSchema = createInsertSchema(
  quotationRecipientModel
)
...
export const createQuotationSchema = z.object({
  ...
  details: z
    .array(quotationDetailInputSchema)
...
export type QuotationRecipientInput = z.infer<
  typeof quotationRecipientInputSchema
>
